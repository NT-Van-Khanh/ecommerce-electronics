...
import com.ptithcm.ecommerce_electronics.service.external.FirebaseService;
...
public class FirebaseServiceImpl implements FirebaseService {
    ...
    public String addImage(MultipartFile imageFile) {
        ...
        String fileName = validateAndGenerateFileName(imageFile, contentType);
    ...
    private static String validateAndGenerateFileName(MultipartFile imageFile, String contentType) {
        ...
        return "ee/" +  UUID.randomUUID() + extension;
    }
}
