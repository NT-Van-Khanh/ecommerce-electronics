...
public class RevenueMController {
    ...
    @GetMapping
    public ResponseEntity<ApiResponse<RevenueDTO>> getRevenueByTime(@RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-07-09") LocalDate from,
                                                                     @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-08-09") LocalDate to,
    ...
    public ResponseEntity<ApiResponse<RevenueDTO>> getRevenueByProductVariant( @PathVariable("id") @PositiveOrZero @Schema(example = "7") Integer productVariantId,
                                                                    @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-07-09") LocalDate from,
                                                                    @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-08-09") LocalDate to,
                                                                    @RequestParam TimeUnit unit){
    ...
    public ResponseEntity<ApiResponse<RevenueDTO>> getRevenueByDiscount( @PathVariable("id") @PositiveOrZero @Schema(example = "1") Integer discountId,
                                                                               @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-07-09") LocalDate from,
                                                                               @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) @Schema(example = "2025-08-09") LocalDate to,
                                                                               @RequestParam TimeUnit unit){
